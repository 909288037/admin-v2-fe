                    ...
                    <ul className="nav" id="main-menu">
                        ...
                        <li>
                            <NavLink exact activeClassName="active-menu" to="/"><i
                                className="fa fa-dashboard"></i> 首页</NavLink>
                        </li>

                        <li className={"active"}>
                            <Link to="/product"><i className="fa fa-list"></i> 商品<span
                        ...
                        <li className={"active"}>
                            <Link to="/order"><i className="fa fa-check-square-o"></i> 订单<span
                                className="fa arrow"></span></Link>
                            <ul className="nav nav-second-level collapse in">
                                <li>
                        ...
                        <li className={"active"}>
                            <Link to="/user"><i className="fa fa-user-o"></i> 用户<span
                                className="fa arrow"></span></Link>
                            <ul className="nav nav-second-level collapse in">
                                <li>
